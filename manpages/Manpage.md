# brew(1) -- abcd's brew, Homebrew but fit different ideas
...
Open Homebrew's online documentation at <https://github.com/xycabcd/brew> in a
browser.
...
* `$HOMEBREW_REPOSITORY/Library/Configs/brew.env`
...
: Use this URL as the Homebrew/brew `git`(1) remote.
  ...
  *Default:* `https://github.com/xycabcd/brew`.
...
Homebrew Documentation: <https://github.com/xycabcd/brew>

Homebrew API: NOT AVALIBLE

`git`(1), `git-log`(1)

## AUTHORS

abcd's brew's author is xycabcd

upstream Homebrew authors:
